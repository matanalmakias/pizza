...
export default function Header2({ headerCls, scroll, isToggled, handleToggle }) {
    ...
    return (
        <>
            <header id="header-2" className={`header navik-header header-shadow center-menu-2 viewport-lg ${headerCls ? headerCls : ""} ${scroll ? "sticky" : ""}`}>
                ...
                <div className="container">
                    ...
                    <div className="navik-header-container">
                        ...
                        <div className="logo" data-mobile-logo="images/logo-02.png" data-sticky-logo="images/logo-02.png">
                            <Link href="#hero-6"><img src="/images/logo-02.png" alt="header-logo" /></Link>
                        </div>
                        ...
                        <nav className="navik-menu menu-caret navik-yellow">
                            <ul className={`top-list ${isToggled ? "d-block" : "d-none"}`}>
                                ...
                                <li className="mega-menu"><Link href="#">Megamenu</Link>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6 col-lg-4">
                                                        <div className="mega-menu-box">
                                                            <div className="mega-menu-media">
                                                                ...
                                                                <div className="mega-menu-media-info">
                                                                    <h4 className="mega-menu-heading"><Link href="/blog-listing">Aliquam and lobortis...</Link></h4>
                                                        ...
                                                        <div className="mega-menu-box">
                                                            <div className="mega-menu-media">
                                                                ...
                                                                <div className="mega-menu-media-info">
                                                                    <h4 className="mega-menu-heading"><Link href="/blog-listing">Donec neca faucibus...</Link></h4>
                                                                    <div className="mega-menu-desc">
                                                        ...
                                                        <div className="mega-menu-box last-menu-box">
                                                            <div className="mega-menu-media">
                                                                ...
                                                                <div className="mega-menu-media-info">
                                                                    <h4 className="mega-menu-heading"><Link href="/blog-listing">Lobortis sem mauris...</Link></h4>
                                                                    <div className="mega-menu-desc">
                                                    ...
                                                    <div className="col-md-6 col-lg-4">
                                                        <div className="mega-menu-box">
                                                            <div className="mega-menu-media">
                                                                ...
                                                                <div className="mega-menu-media-info">
                                                                    <h4 className="mega-menu-heading"><Link href="/blog-listing">Fusce semper aliquet...</Link></h4>
                                                                    <div className="mega-menu-desc">
                                                        ...
                                                        <div className="mega-menu-box">
                                                            <div className="mega-menu-media">
                                                                ...
                                                                <div className="mega-menu-media-info">
                                                                    <h4 className="mega-menu-heading"><Link href="/blog-listing">Aliquam libero ipsum...</Link></h4>
                                                                    <div className="mega-menu-desc">
                                                        ...
                                                        <div className="mega-menu-box last-menu-box">
                                                            <div className="mega-menu-media">
                                                                ...
                                                                <div className="mega-menu-media-info">
                                                                    <h4 className="mega-menu-heading"><Link href="/blog-listing">Posuere himenaeos...</Link></h4>
                                                                    <div className="mega-menu-desc">
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mega-menu-box last-menu-box">
                                                            ...
                                                            <h4 className="mega-menu-heading"><Link href="/blog-listing">Etiam semper mauris...</Link></h4>
                                                            <div className="mega-menu-desc">
